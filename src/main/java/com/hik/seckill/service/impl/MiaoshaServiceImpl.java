...
import com.hik.seckill.redis.MiaoshaKey;
import com.hik.seckill.redis.RedisService;
import com.hik.seckill.service.IMiaoshaService;
...
public class MiaoshaServiceImpl implements IMiaoshaService {
    ...
    public boolean checkVerifyCodeRegister(int verifyCode) {
        Object codeOld = redisService.get(MiaoshaKey.getMiaoshaVerifyCodeRegister, "register", Integer.class);
        Integer code = (Integer) codeOld;
        if (code == null || code - verifyCode != 0) {
            return false;
        }
        redisService.delete(MiaoshaKey.getMiaoshaVerifyCodeRegister, "register");
        return true;
    }
    ...
    public boolean checkVerifyCode(MiaoshaUser user, long goodsId, int verifyCode) {
        ...
        Integer codeOld = (Integer) redisService.get(MiaoshaKey.getMiaoshaVerifyCode,
    ...
    public boolean checkPath(MiaoshaUser user, long goodsId, String path) {
        ...
        String pathOld = (String) redisService.get(MiaoshaKey.getMiaoshaPath,
    ...
    public long getMiaoshaResult(Long userId, long goodsId) {
        MiaoshaOrder order = orderService.getMiaoshaOrderByUserGoodsId(userId, goodsId);
        if (order != null) {
